...
<div bind:this={folderElement} class="relative {className}">
	...
	{#if collapsible}
		...
		>
			...
			>
				<button class="w-full py-1.5 pl-2 flex items-center gap-1.5 text-l font-medium">
					<div class="text-black-300 dark:text-gray-600">
						{#if open}
					...
					<div class="translate-y-[0.5px] ml-1 text-ms text-black dark:text-white">
						{name}
					</div>
				</button>
