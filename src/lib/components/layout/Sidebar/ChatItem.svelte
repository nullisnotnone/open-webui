...
<div
	...
	class="{className} ml-5 text-l text-gray-500 relative group"
	draggable={draggable && !confirmEdit}
>
	{#if confirmEdit}
		<div
			class=" w-full flex justify-between rounded-lg px-[11px] {id === $chatId ||
			confirmEdit
	...
	{:else}
		...
		>
			<div class=" flex self-center flex-1 w-full">
				<div dir="auto" class="text-left self-center text-ellipsis overflow-hidden w-full h-[20px]">
					{title}
				</div>
			</div>
		</a>
